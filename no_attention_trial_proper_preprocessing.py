...
model.fit(data_train, labels_train,epochs=10, validation_data=(data_val, labels_val),batch_size=256, shuffle= True)
...
# sample_submission.to_csv('%.4f_'%(bst_val_score)+name+'.csv', index=False)


sample_submission.to_csv(name+'2.csv', index=False)